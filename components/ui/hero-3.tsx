...
export function Hero3({
  ...
  return (
    <section className="dark bg-background text-foreground relative min-h-screen w-full overflow-hidden font-sans">
      ...
      >
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-5 sm:px-10 lg:px-20">
          <a
            href="#"
      ...
      <div className="relative z-10 mx-auto flex min-h-screen max-w-6xl flex-col justify-between px-6 pt-32 pb-12 sm:px-10 md:pt-40 lg:px-20 lg:pt-48">
        <motion.div
          variants={container}
          initial="hidden"
          whileInView="visible"
